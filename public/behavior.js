...
function kpi(icon,value,label,color){return "<div class='beh-kpi "+color+"'><span class='beh-kpi-icon'>"+icon+"</span><div><strong>"+value+"</strong><small>"+esc(label)+"</small></div></div>";}
